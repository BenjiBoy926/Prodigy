...
public static class DataManager 
{
	...
	private static string dataPath = Application.persistentDataPath + "/stealthMage.dat";
	private static int totalLevels = 23;	// Total levels in the game
	...
	public static void Load ()
	{
		...
		// Otherwise, construct data from scratch
			...
			data = new PlayerData (totalLevels);
			Debug.Log ("DataManager loaded a new instance of PlayerData");
		}
	...
	public static void CompleteFirst (PlayerFirst action)
	{
		data.CompleteFirst (action);
		Save ();
	}
}
